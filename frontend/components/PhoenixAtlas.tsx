...
export default function Atlas(){
 ...
 return <div className="atlas-operational" ref={wrap}>
  <div className="atlas-topline"><div><div className="eyebrow">OBSERVE + DIAGNOSE · PHOENIX SPATIAL INTELLIGENCE</div><h1>See the city. Trust only what is observed.</h1><p>Citywide OSM context stays neutral; only four downtown cells carry live provider-backed metrics.</p></div><div className="atlas-health"><span className={fs.length===4?"live":"warn"}><i/>{fs.length===4?"LIVE PROVIDER DATA":"DATA CHECK"}</span><span>{fs.length||"—"} VERIFIED CELLS</span><span>PHX-DOWNTOWN ONLY</span></div></div>
